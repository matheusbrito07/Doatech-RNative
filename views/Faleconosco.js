...
export default function Faleconosco(props)
{
    return(
        <View style={styles.container}>
            ...
            <TouchableOpacity>
                <Text style={{ marginTop: 30, fontSize:25, color:'#deb458',fontWeight: "bold", }}>Mande sua mensagem:</Text>
            </TouchableOpacity>
            ...
            <Text style={{textAlign: "center",color: "#fff",fontSize: 18,fontWeight: "bold",}}>Enviar Mensagem</Text>
