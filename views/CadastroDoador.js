...
export default function CadastroDoador(props)
{
    return(
        <View style={styles.container}>
            ...
            <TouchableOpacity>
                <Text style={{ marginTop: 30, fontSize:25, color:'#deb458',fontWeight: "bold", }}>CADASTRAR DOADOR:</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity style={{backgroundColor: "#deb458",padding: 5,width: 200, borderRadius: 30,alignItems: "center",justifyContent: "center",marginTop: 30,}}>
                <Text style={{textAlign: "center",color: "#fff",fontSize: 18,fontWeight: "bold",}}>CADASTRAR</Text>
            </TouchableOpacity>
