...
export default function Doador(props)
{
    ...
    return(
        <View style={styles.container}>
            ...
            <TouchableOpacity>
                <Text style={{ marginTop: 30, fontSize:25, color:'#deb458',fontWeight: "bold", }}>CONFIRME SUA DOAÇÃO:</Text>
            </TouchableOpacity>

            <TextInput style={styles.input} placeholder="Item que você irá doar" onChangeText={text=>setNome(text)}/>
            <TextInput style={styles.input} placeholder="Breve descrição do item doado (Ex: Notebook)" onChangeText={text=>setNome(text)}/>
